...
public:
	explicit Sandbox() : Synergy::Application(),
        m_CameraController(1600.f / 1200.0f),
    ...
    virtual bool OnUserCreate() override
    {
        ...
        float height = (1200.f / m_TileMapRows) / 1200.f;

        glm::vec2 tileSize { height, height };
        ...
        // Tile Map
        {
            ...
            map.size = { m_TileMapColumns, m_TileMapRows };
            map.tile = tileSize;
            map.atlas = m_Atlas;
            map.tiles = tiles;
        ...
        // Interface
        {
            glm::vec2 padding = { 10.f / 1600.f, 10.f / 1200.f };
            glm::vec2 size = { 64.f / 1600.f, 64.f / 1200.f };
...
private:
    ...
    static constexpr uint8_t m_TileMapColumns = 16;
    static constexpr uint8_t m_TileMapRows = 16;
    uint8_t m_TileMap[m_TileMapRows * m_TileMapColumns] = {
         6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,
         6,  6,  3, 11, 11, 11, 11, 11, 11, 11,  4,  6,  3, 11, 11, 11,
         6,  6,  7, 14, 14, 14, 14, 14, 14, 14,  5,  6,  7, 14, 14, 14,
         6,  6,  7, 14,  0,  1,  1,  1,  2, 14,  5,  6,  7, 14,  0,  1,
         6,  6,  7, 14,  5,  6,  6,  6,  7, 14,  5,  6,  7, 14,  5,  6,
         6,  6,  7, 14,  5,  6,  6,  6,  7, 14,  5,  6,  7, 14,  5,  6,
         6,  6,  7, 14,  5,  6,  3, 11, 12, 14,  5,  6,  7, 14,  5,  6,
         6,  6,  7, 14,  5,  6,  7, 14, 14, 14,  5,  6,  7, 14,  5,  6,
         6,  6,  7, 14,  5,  6,  7, 14,  0,  1,  9,  6,  7, 14,  5,  6,
         6,  6,  7, 14,  5,  6,  7, 14,  5,  6,  6,  6,  7, 14,  5,  6,
        11, 11, 12, 14,  5,  6,  7, 14,  5,  6,  6,  6,  7, 14,  5,  6,
        14, 14, 14, 14,  5,  6,  7, 14,  5,  6,  6,  6,  7, 14,  5,  6,
         1,  1,  1,  1,  9,  6,  7, 14, 10, 11, 11, 11, 12, 14,  5,  6,
         6,  6,  6,  6,  6,  6,  7, 14, 14, 14, 14, 14, 14, 14,  5,  6,
         6,  6,  6,  6,  6,  6,  8,  1,  1,  1,  1,  1,  1,  1,  9,  6,
         6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6
    };
};
